      ...
      {user && isOpen && (
        ...
        >
          ...
          <div className="flex flex-col mt-10">
            <Link
              to="/"
              className="text-[#D1D5DB]  capitalize text-2xl font-semibold tracking-tight leading-none"
            >
              Home
            </Link>
            <Link
              to="/courses"
              className="text-[#d1d5db] capitalize text-2xl font-semibold tracking-tight leading-none mt-4"
            >
              Course
            </Link>
              ...
              {user && (
                <>
                  {user.role === "Instructor" && (
                    <Link
                      to="/admin/dashboard"
                      className=" text-[#D1D5DB] font-semibold text-2xl"
                    >
                      Admin
                    </Link>
                  )}
                  {user ? (
                    <button
                      onClick={logoutHandle}
                      className="text-[#D1D5DB] mt-4 cursor-pointer bg-red-900 px-5 py-1.5 rounded font-semibold capitalize"
                    >
                      logout
                    </button>
                  ) : null}
